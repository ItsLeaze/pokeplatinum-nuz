...
static void DrawSkillsPageWindows(PokemonSummaryScreen *summaryScreen)
{
    ...
    if (summaryScreen->showIVs == 1) {
        ...
        PrintStringToWindow(summaryScreen, &summaryScreen->extraWindows[SUMMARY_WINDOW_ATTACK], GetStatTextColor(summaryScreen, STAT_ATTACK), ALIGN_RIGHT);
        ...
        PrintStringToWindow(summaryScreen, &summaryScreen->extraWindows[SUMMARY_WINDOW_DEFENSE], GetStatTextColor(summaryScreen, STAT_DEFENSE), ALIGN_RIGHT);
        ...
        PrintStringToWindow(summaryScreen, &summaryScreen->extraWindows[SUMMARY_WINDOW_SP_ATTACK], GetStatTextColor(summaryScreen, STAT_SPECIAL_ATTACK), ALIGN_RIGHT);
        ...
        PrintStringToWindow(summaryScreen, &summaryScreen->extraWindows[SUMMARY_WINDOW_SP_DEFENSE], GetStatTextColor(summaryScreen, STAT_SPECIAL_DEFENSE), ALIGN_RIGHT);
        SetAndFormatNumberBuf(summaryScreen, PokemonSummary_Text_TemplateSpeed, summaryScreen->monData.speed, 3, PADDING_MODE_NONE);
        PrintStringToWindow(summaryScreen, &summaryScreen->extraWindows[SUMMARY_WINDOW_SPEED], GetStatTextColor(summaryScreen, STAT_SPEED), ALIGN_RIGHT);
    }
