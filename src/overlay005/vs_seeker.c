...
const VsSeekerRematchData gVsSeekerRematchData[] = {
    NoUniqueRematches(TRAINER_R204N_AROMA_LADY_TAYLOR),
    { TRAINER_R205S_AROMA_LADY_ELIZABETH, TRAINER_R205S_AROMA_LADY_ELIZABETH_REMATCH_1, TRAINER_R205S_AROMA_LADY_ELIZABETH_REMATCH_2, _, TRAINER_R205S_AROMA_LADY_ELIZABETH_REMATCH_3, VS_SEEKER_REMATCH_DATA_END },
    NoUniqueRematches(TRAINER_R208_AROMA_LADY_HANNAH),
    { TRAINER_R208_ARTIST_WILLIAM, _, TRAINER_R208_ARTIST_WILLIAM_REMATCH_1, TRAINER_R208_ARTIST_WILLIAM_REMATCH_2, _, TRAINER_R208_ARTIST_WILLIAM_REMATCH_3 },
    NoUniqueRematches(TRAINER_R205S_BATTLE_GIRL_KELSEY),
    { TRAINER_R207_BATTLE_GIRL_HELEN, _, TRAINER_R207_BATTLE_GIRL_HELEN_REMATCH_1, TRAINER_R207_BATTLE_GIRL_HELEN_REMATCH_2, _, TRAINER_R207_BATTLE_GIRL_HELEN_REMATCH_3 },
    { TRAINER_R210N_BIRD_KEEPER_BRIANNA, _, _, TRAINER_R210N_BIRD_KEEPER_BRIANNA_REMATCH_1, _, TRAINER_R210N_BIRD_KEEPER_BRIANNA_REMATCH_2 },
    NoUniqueRematches(TRAINER_R211W_BIRD_KEEPER_ALEXANDRA),
    NoUniqueRematches(TRAINER_R211E_BIRD_KEEPER_KATHERINE),
    { TRAINER_BIRD_KEEPER_AUDREY, _, _, _, _, TRAINER_BIRD_KEEPER_AUDREY_REMATCH },
    NoUniqueRematches(TRAINER_BIRD_KEEPER_GENEVA),
    { TRAINER_R209_BREEDER_ALBERT, _, TRAINER_R209_BREEDER_ALBERT_REMATCH_1, TRAINER_R209_BREEDER_ALBERT_REMATCH_2, TRAINER_R209_BREEDER_ALBERT_REMATCH_3, VS_SEEKER_REMATCH_DATA_END },
    NoUniqueRematches(TRAINER_R210S_BREEDER_KAHLIL),
    { TRAINER_R209_BREEDER_JENNIFER, _, TRAINER_R209_BREEDER_JENNIFER_REMATCH_1, TRAINER_R209_BREEDER_JENNIFER_REMATCH_2, TRAINER_R209_BREEDER_JENNIFER_REMATCH_3, VS_SEEKER_REMATCH_DATA_END },
    NoUniqueRematches(TRAINER_R210S_BREEDER_AMBER),
    NoUniqueRematches(TRAINER_R205S_CAMPER_JACOB),
    NoUniqueRematches(TRAINER_R207_CAMPER_ANTHONY),
    ...
    NoUniqueRematches(TRAINER_R216_ACE_TRAINER_BLAKE),
    NoUniqueRematches(TRAINER_R216_ACE_TRAINER_GARRETT),
    { TRAINER_R217_ACE_TRAINER_DALTON, _, _, _, TRAINER_R217_ACE_TRAINER_DALTON_REMATCH, VS_SEEKER_REMATCH_DATA_END },
    NoUniqueRematches(TRAINER_R216_ACE_TRAINER_LAURA),
    NoUniqueRematches(TRAINER_R216_ACE_TRAINER_MARIA),
    { TRAINER_R217_ACE_TRAINER_OLIVIA, _, _, _, TRAINER_R217_ACE_TRAINER_OLIVIA_REMATCH, VS_SEEKER_REMATCH_DATA_END },
    NoUniqueRematches(TRAINER_DUMMY_087),
    NoUniqueRematches(TRAINER_R214_COLLECTOR_DOUGLAS),
    NoUniqueRematches(TRAINER_R214_COLLECTOR_BRADY),
    ...
    NoUniqueRematches(TRAINER_R209_COWGIRL_SHELLEY),
    { TRAINER_DUMMY_058, _, _, TRAINER_DUMMY_058_REMATCH_1, _, TRAINER_DUMMY_058_REMATCH_2 },
    NoUniqueRematches(TRAINER_R206_CYCLIST_AXEL),
    NoUniqueRematches(TRAINER_R206_CYCLIST_JAMES),
    { TRAINER_R206_CYCLIST_JOHN, _, TRAINER_R206_CYCLIST_JOHN_REMATCH_1, TRAINER_R206_CYCLIST_JOHN_REMATCH_2, _, TRAINER_R206_CYCLIST_JOHN_REMATCH_3 },
    NoUniqueRematches(TRAINER_R206_CYCLIST_RYAN),
    NoUniqueRematches(TRAINER_R206_CYCLIST_MEGAN),
    NoUniqueRematches(TRAINER_R206_CYCLIST_NICOLE),
    { TRAINER_R206_CYCLIST_KAYLA, _, TRAINER_R206_CYCLIST_KAYLA_REMATCH_1, TRAINER_R206_CYCLIST_KAYLA_REMATCH_2, _, TRAINER_R206_CYCLIST_KAYLA_REMATCH_3 },
    NoUniqueRematches(TRAINER_R206_CYCLIST_RACHEL),
    NoUniqueRematches(TRAINER_R210N_DOUBLE_TEAM_ZAC_AND_JEN),
    { TRAINER_R210N_DRAGON_TAMER_PATRICK, _, _, TRAINER_R210N_DRAGON_TAMER_PATRICK_REMATCH_1, _, TRAINER_R210N_DRAGON_TAMER_PATRICK_REMATCH_2 },
    { TRAINER_R224_DRAGON_TAMER_HAYDEN, _, _, _, _, TRAINER_R224_DRAGON_TAMER_HAYDEN_REMATCH },
    ...
    NoUniqueRematches(TRAINER_R210N_ACE_TRAINER_ERNEST),
    { TRAINER_ACE_TRAINER_JAKE, _, _, _, TRAINER_ACE_TRAINER_JAKE_REMATCH, VS_SEEKER_REMATCH_DATA_END },
    NoUniqueRematches(TRAINER_R215_THORTON),
    NoUniqueRematches(TRAINER_R224_ACE_TRAINER_RUBEN),
    ...
    NoUniqueRematches(TRAINER_R210N_ACE_TRAINER_ALYSSA),
    { TRAINER_ACE_TRAINER_SHANNON, _, _, _, TRAINER_ACE_TRAINER_SHANNON_REMATCH, VS_SEEKER_REMATCH_DATA_END },
    NoUniqueRematches(TRAINER_R224_ACE_TRAINER_JAMIE),
    NoUniqueRematches(TRAINER_R215_ARGENTA),
    ...
    { TRAINER_R214_PSYCHIC_MITCHELL, _, _, TRAINER_R214_PSYCHIC_MITCHELL_REMATCH_1, _, TRAINER_R214_PSYCHIC_MITCHELL_REMATCH_2 },
    { TRAINER_R224_PSYCHIC_MAXWELL, _, _, _, _, TRAINER_R224_PSYCHIC_MAXWELL_REMATCH },
    { TRAINER_PSYCHIC_CORBIN, _, _, _, _, TRAINER_PSYCHIC_CORBIN_REMATCH },
    { TRAINER_R214_PSYCHIC_ABIGAIL, _, _, TRAINER_R214_PSYCHIC_ABIGAIL_REMATCH_1, _, TRAINER_R214_PSYCHIC_ABIGAIL_REMATCH_2 },
    { TRAINER_R224_PSYCHIC_BRITTNEY, _, _, _, _, TRAINER_R224_PSYCHIC_BRITTNEY_REMATCH },
    ...
    NoUniqueRematches(TRAINER_R205N_FISHERMAN_ANDREW),
    { TRAINER_R205N_FISHERMAN_JOSEPH, _, TRAINER_R205N_FISHERMAN_JOSEPH_REMATCH_1, _, TRAINER_R205N_FISHERMAN_JOSEPH_REMATCH_2, VS_SEEKER_REMATCH_DATA_END },
    NoUniqueRematches(TRAINER_R205N_FISHERMAN_ZACHARY),
    NoUniqueRematches(TRAINER_R208_FISHERMAN_CODY),
    ...
    NoUniqueRematches(TRAINER_R213_FISHERMAN_KENNETH),
    { TRAINER_R218_FISHERMAN_MIGUEL, _, _, _, TRAINER_R218_FISHERMAN_MIGUEL_REMATCH, VS_SEEKER_REMATCH_DATA_END },
    NoUniqueRematches(TRAINER_R218_FISHERMAN_LUC),
    NoUniqueRematches(TRAINER_FISHERMAN_CORY),
    NoUniqueRematches(TRAINER_R222_FISHERMAN_BRETT),
    { TRAINER_R222_FISHERMAN_ALEC, _, _, _, TRAINER_R222_FISHERMAN_ALEC_REMATCH, VS_SEEKER_REMATCH_DATA_END },
    NoUniqueRematches(TRAINER_R222_FISHERMAN_GEORGE),
    NoUniqueRematches(TRAINER_R222_FISHERMAN_COLE),
    NoUniqueRematches(TRAINER_R204N_TWINS_LIV_AND_LIZ),
    { TRAINER_R210S_TWINS_TERI_AND_TIA, _, _, TRAINER_R210S_TWINS_TERI_AND_TIA_REMATCH_1, _, TRAINER_R210S_TWINS_TERI_AND_TIA_REMATCH_2 },
    NoUniqueRematches(TRAINER_TWINS_EMMA_AND_LIL),
    { TRAINER_R214_PI_CARLOS, _, _, TRAINER_R214_PI_CARLOS_REMATCH_1, _, TRAINER_R214_PI_CARLOS_REMATCH_2 },
    ...
    { TRAINER_R218_GUITARIST_TONY, _, _, _, TRAINER_R218_GUITARIST_TONY_REMATCH, VS_SEEKER_REMATCH_DATA_END },
    ...
    NoUniqueRematches(TRAINER_R224_RUIN_MANIAC_LARRY),
    ...
    NoUniqueRematches(TRAINER_R209_JOGGER_RICHARD),
    ...
    NoUniqueRematches(TRAINER_R208_BLACK_BELT_KYLE),
    NoUniqueRematches(TRAINER_R210N_BLACK_BELT_ADAM),
    NoUniqueRematches(TRAINER_R211E_BLACK_BELT_SEAN),
    ...
    NoUniqueRematches(TRAINER_R217_BLACK_BELT_LUKE),
    { TRAINER_R216_BLACK_BELT_PHILIP, _, _, _, TRAINER_R216_BLACK_BELT_PHILIP_REMATCH, VS_SEEKER_REMATCH_DATA_END },
    NoUniqueRematches(TRAINER_R224_BLACK_BELT_CARL),
    { TRAINER_BLACK_BELT_DAVON, _, _, _, _, TRAINER_BLACK_BELT_DAVON_REMATCH },
    NoUniqueRematches(TRAINER_BLACK_BELT_GRIFFIN),
    NoUniqueRematches(TRAINER_R209_YOUNG_COUPLE_TY_AND_SUE),
    { TRAINER_SOCIALITE_REINA, _, _, TRAINER_SOCIALITE_REINA_REMATCH_1, _, TRAINER_SOCIALITE_REINA_REMATCH_2 },
    NoUniqueRematches(TRAINER_R202_LASS_NATALIE),
    { TRAINER_R204S_LASS_SAMANTHA, TRAINER_R204S_LASS_SAMANTHA_REMATCH_1, TRAINER_R204S_LASS_SAMANTHA_REMATCH_2, _, TRAINER_R204S_LASS_SAMANTHA_REMATCH_3, VS_SEEKER_REMATCH_DATA_END },
    NoUniqueRematches(TRAINER_R204S_LASS_SARAH),
    ...
    NoUniqueRematches(TRAINER_R205S_HIKER_DANIEL),
    NoUniqueRematches(TRAINER_R205S_HIKER_NICHOLAS),
    NoUniqueRematches(TRAINER_R207_HIKER_KEVIN),
    NoUniqueRematches(TRAINER_R207_HIKER_JUSTIN),
    NoUniqueRematches(TRAINER_R208_HIKER_ROBERT),
    NoUniqueRematches(TRAINER_R208_HIKER_ALEXANDER),
    NoUniqueRematches(TRAINER_R208_HIKER_JONATHAN),
    NoUniqueRematches(TRAINER_HIKER_LOUIS),
    { TRAINER_R206_HIKER_THEODORE, _, TRAINER_R206_HIKER_THEODORE_REMATCH_1, TRAINER_R206_HIKER_THEODORE_REMATCH_2, _, TRAINER_R206_HIKER_THEODORE_REMATCH_3 },
    { TRAINER_R204N_BUG_CATCHER_BRANDON, TRAINER_R204N_BUG_CATCHER_BRANDON_REMATCH_1, TRAINER_R204N_BUG_CATCHER_BRANDON_REMATCH_2, _, TRAINER_R204N_BUG_CATCHER_BRANDON_REMATCH_3, VS_SEEKER_REMATCH_DATA_END },
    ...
    NoUniqueRematches(TRAINER_R205S_PICNICKER_SIENA),
    NoUniqueRematches(TRAINER_R207_PICNICKER_LAUREN),
    ...
    { TRAINER_R209_POKE_KID_DANIELLE, _, TRAINER_R209_POKE_KID_DANIELLE_REMATCH_1, TRAINER_R209_POKE_KID_DANIELLE_REMATCH_2, TRAINER_R209_POKE_KID_DANIELLE_REMATCH_3, VS_SEEKER_REMATCH_DATA_END },
    ...
    NoUniqueRematches(TRAINER_R222_POLICEMAN_THOMAS_NO_LONGER_USED),
    NoUniqueRematches(TRAINER_RICH_BOY_JASON),
    { TRAINER_R222_RICH_BOY_TREY, _, _, _, TRAINER_R222_RICH_BOY_TREY_REMATCH_1, TRAINER_R222_RICH_BOY_TREY_REMATCH_2 },
    ...
    NoUniqueRematches(TRAINER_R213_SAILOR_PAUL),
    NoUniqueRematches(TRAINER_R222_SAILOR_LUTHER_NO_LONGER_USED),
    { TRAINER_R222_SAILOR_MARC_NO_LONGER_USED, _, _, _, TRAINER_R222_SAILOR_MARC_REMATCH_1_NO_LONGER_USED, TRAINER_R222_SAILOR_MARC_REMATCH_2_NO_LONGER_USED },
    NoUniqueRematches(TRAINER_R218_SAILOR_SKYLER),
    { TRAINER_R223_SAILOR_ZACHARIAH, _, _, _, _, TRAINER_R223_SAILOR_ZACHARIAH_REMATCH },
    ...
    NoUniqueRematches(TRAINER_R210N_NINJA_BOY_JOEL),
    NoUniqueRematches(TRAINER_R210N_NINJA_BOY_NATHAN),
    NoUniqueRematches(TRAINER_R210N_NINJA_BOY_DAVIDO),
    { TRAINER_R211W_NINJA_BOY_ZACH, _, TRAINER_R211W_NINJA_BOY_ZACH_REMATCH_1, TRAINER_R211W_NINJA_BOY_ZACH_REMATCH_2, TRAINER_R211W_NINJA_BOY_ZACH_REMATCH_3, VS_SEEKER_REMATCH_DATA_END },
    NoUniqueRematches(TRAINER_R211E_NINJA_BOY_NICK),
    NoUniqueRematches(TRAINER_R217_NINJA_BOY_MATTHEW),
    NoUniqueRematches(TRAINER_R217_NINJA_BOY_ETHAN),
    ...
    { TRAINER_R213_BEAUTY_CYNDY, _, _, TRAINER_R213_BEAUTY_CYNDY_REMATCH_1, _, TRAINER_R213_BEAUTY_CYNDY_REMATCH_2 },
    NoUniqueRematches(TRAINER_R214_BEAUTY_DEVON),
    NoUniqueRematches(TRAINER_R222_BEAUTY_NICOLA),
    NoUniqueRematches(TRAINER_R216_SKIER_BRADLEY),
    { TRAINER_R216_SKIER_EDWARD, _, _, TRAINER_R216_SKIER_EDWARD_REMATCH_1, TRAINER_R216_SKIER_EDWARD_REMATCH_2, VS_SEEKER_REMATCH_DATA_END },
    NoUniqueRematches(TRAINER_R217_SKIER_SHAWN),
    { TRAINER_R217_SKIER_BJORN, _, _, TRAINER_R217_SKIER_BJORN_REMATCH_1, _, TRAINER_R217_SKIER_BJORN_REMATCH_2 },
    NoUniqueRematches(TRAINER_R216_SKIER_KAITLYN),
    { TRAINER_R216_SKIER_ANDREA, _, _, TRAINER_R216_SKIER_ANDREA_REMATCH_1, TRAINER_R216_SKIER_ANDREA_REMATCH_2, VS_SEEKER_REMATCH_DATA_END },
    NoUniqueRematches(TRAINER_R217_SKIER_LEXIE),
    { TRAINER_R217_SKIER_MADISON, _, _, TRAINER_R217_SKIER_MADISON_REMATCH_1, TRAINER_R217_SKIER_MADISON_REMATCH_2, VS_SEEKER_REMATCH_DATA_END },
    NoUniqueRematches(TRAINER_R213_SWIMMER_SHELTIN),
    NoUniqueRematches(TRAINER_R213_SWIMMER_EVAN),
    ...
    { TRAINER_R223_SWIMMER_WESLEY_NO_LONGER_USED, _, _, _, _, TRAINER_R223_SWIMMER_WESLEY_NO_LONGER_USED_REMATCH },
    NoUniqueRematches(TRAINER_R223_SWIMMER_RICARDO),
    { TRAINER_R223_SWIMMER_FRANCISCO, _, _, _, _, TRAINER_R223_SWIMMER_FRANCISCO_REMATCH },
    NoUniqueRematches(TRAINER_R223_SWIMMER_COLTON_NO_LONGER_USED),
    NoUniqueRematches(TRAINER_R223_SWIMMER_TROY),
    NoUniqueRematches(TRAINER_R223_SWIMMER_OSCAR),
    ...
    NoUniqueRematches(TRAINER_R213_SWIMMER_HALEY),
    NoUniqueRematches(TRAINER_R213_SWIMMER_MARY),
    ...
    { TRAINER_R223_SWIMMER_MIRANDA, _, _, _, _, TRAINER_R223_SWIMMER_MIRANDA_REMATCH },
    NoUniqueRematches(TRAINER_R223_SWIMMER_AUBREE_NO_LONGER_USED),
    NoUniqueRematches(TRAINER_R223_SWIMMER_PAIGE_NO_LONGER_USED),
    { TRAINER_R223_SWIMMER_CRYSTAL, _, _, _, _, TRAINER_R223_SWIMMER_CRYSTAL_REMATCH },
    NoUniqueRematches(TRAINER_R223_SWIMMER_CASSANDRA),
    NoUniqueRematches(TRAINER_R223_SWIMMER_GABRIELLE_NO_LONGER_USED),
    ...
    { TRAINER_R202_YOUNGSTER_TRISTAN, TRAINER_YOUNGSTER_TRISTAN_REMATCH_1, TRAINER_YOUNGSTER_TRISTAN_REMATCH_2, TRAINER_YOUNGSTER_TRISTAN_REMATCH_3, VS_SEEKER_REMATCH_DATA_END, VS_SEEKER_REMATCH_DATA_END },
    NoUniqueRematches(TRAINER_R202_YOUNGSTER_LOGAN),
    NoUniqueRematches(TRAINER_R203_YOUNGSTER_MICHAEL),
    NoUniqueRematches(TRAINER_R204S_YOUNGSTER_TYLER),
    NoUniqueRematches(TRAINER_R207_YOUNGSTER_AUSTIN),
    ...
    { TRAINER_R213_TUBER_JARED, _, TRAINER_R213_TUBER_JARED_REMATCH_1, _, TRAINER_R213_TUBER_JARED_REMATCH_2, VS_SEEKER_REMATCH_DATA_END },
    NoUniqueRematches(TRAINER_TUBER_TRENTON),
    NoUniqueRematches(TRAINER_R222_TUBER_CONNER),
    { TRAINER_R213_TUBER_CHELSEA, _, _, TRAINER_R213_TUBER_CHELSEA_REMATCH_1, TRAINER_R213_TUBER_CHELSEA_REMATCH_2, VS_SEEKER_REMATCH_DATA_END },
    NoUniqueRematches(TRAINER_TUBER_MARIEL),
    NoUniqueRematches(TRAINER_R222_TUBER_HOLLY),
    { TRAINER_R210N_VETERAN_BRIAN, _, _, TRAINER_R210N_VETERAN_BRIAN_REMATCH_1, _, TRAINER_R210N_VETERAN_BRIAN_REMATCH_2 },
    { TRAINER_R224_VETERAN_ARMANDO, _, _, _, _, TRAINER_R224_VETERAN_ARMANDO_REMATCH },
