...
#define SIDE_CONDITION_LUCKY_CHANT_INIT (SIDE_CONDITION_LUCKY_CHANT_0 | SIDE_CONDITION_LUCKY_CHANT_1 | SIDE_CONDITION_LUCKY_CHANT_2)
...
#define FIELD_CONDITION_TRICK_ROOM_PERM (1 << 19)
...
#define FIELD_CONDITION_PERM      (FIELD_CONDITION_RAINING_PERM | FIELD_CONDITION_SANDSTORM_PERM | FIELD_CONDITION_SUNNY_PERM | FIELD_CONDITION_HAILING_PERM)
...
#define FIELD_CONDITION_GRAVITY_INIT    (FIELD_CONDITION_GRAVITY_0 | FIELD_CONDITION_GRAVITY_1 | FIELD_CONDITION_GRAVITY_2)
